...
function App() {
  ...
  useEffect(()=>{
    ...
    $(document).on("click", "#isDisabledTrue", ()=>{
      $("#isDisabledTrue").css('background', '#2772B7');
      $("#isDisabledTrue").css('color', 'white');
      $("#isDisabledFalse").css('background', 'white');
      $("#isDisabledFalse").css('color', '#2772B7');
      setCheckDisabled(true);
    })

    $(document).on("click", "#isDisabledFalse", ()=>{
      $("#isDisabledTrue").css('background', 'white');
      $("#isDisabledTrue").css('color', '#2772B7');
      $("#isDisabledFalse").css('background', '#2772B7');
      $("#isDisabledFalse").css('color', 'white');
      setCheckDisabled(false);
    })

    $(document).on("click", "#hasPetTrue", ()=>{
      $("#hasPetTrue").css('background', '#2772B7');
      $("#hasPetTrue").css('color', 'white');
      $("#hasPetFalse").css('background', 'white');
      $("#hasPetFalse").css('color', '#2772B7');
      setCheckPet(true);
    })

    $(document).on("click", "#hasPetFalse", ()=>{
      $("#hasPetTrue").css('background', 'white');
      $("#hasPetTrue").css('color', '#2772B7');
      $("#hasPetFalse").css('background', '#2772B7');
      $("#hasPetFalse").css('color', 'white');
      setCheckPet(false);
    })
    ...
    $(document).on("click", "#canOrderedTrue", ()=>{
      $("#canOrderedTrue").css('background', '#2772B7');
      $("#canOrderedTrue").css('color', 'white');
      $("#canOrderedFalse").css('background', 'white');
      $("#canOrderedFalse").css('color', '#2772B7');
      setCheckOrdered(true);
    })

    $(document).on("click", "#canOrderedFalse", ()=>{
      $("#canOrderedTrue").css('background', 'white');
      $("#canOrderedTrue").css('color', '#2772B7');
      $("#canOrderedFalse").css('background', '#2772B7');
      $("#canOrderedFalse").css('color', 'white');
      setCheckOrdered(false);
    })

    $(document).on("click", "#canPromotionTrue", ()=>{
      $("#canPromotionTrue").css('background', '#2772B7');
      $("#canPromotionTrue").css('color', 'white');
      $("#canPromotionFalse").css('background', 'white');
      $("#canPromotionFalse").css('color', '#2772B7');
      setCheckPromotion(true);
    })

    $(document).on("click", "#canPromotionFalse", ()=>{
      $("#canPromotionTrue").css('background', 'white');
      $("#canPromotionTrue").css('color', '#2772B7');
      $("#canPromotionFalse").css('background', '#2772B7');
      $("#canPromotionFalse").css('color', 'white');
  ...
  if(page == "Home"){
    ...
    return(
      <div>
        <HomeHeader></HomeHeader>
        <RecommendationBody region={subLoc} data={data} filteredType={filteredType}></RecommendationBody>
      </div>
    )
  }
}
